...
public class QuestionServiceTestConstants {
    ...
    public static final Question TEST_QUESTION_3 = new Question("Test 3", "Test 3");
    public static final Question TEST_QUESTION_4 = new Question("Test 4", "Test 4");
    ...
    public static final Set<Question> TEST_SET_SIZE_4 = new HashSet<>(Set.of(TEST_QUESTION_1, TEST_QUESTION_2, TEST_QUESTION_3, TEST_QUESTION_4));
